...
package com.sema.package.mobile.test;
...
import com.sema.package.mobile.ui.CarouselActivity;
...
public class NewsViewTest extends ActivityInstrumentationTestCase2<CarouselActivity> {
    ...
    /**
     * Create test for {@link com.sema.package.mobile.ui.CarouselActivity}
     */
    public NewsViewTest() {
