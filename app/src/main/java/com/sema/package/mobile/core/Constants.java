...
public final class Constants {
    ...
    public static final class Auth {
         ...
         * Account type id
         */
        public static final String BOOTSTRAP_ACCOUNT_TYPE = "com.sema.package.mobile";

        /**
         * Account name
         */
        public static final String BOOTSTRAP_ACCOUNT_NAME = "Sema";

        /**
         * Provider id
         */
        public static final String BOOTSTRAP_PROVIDER_AUTHORITY = "com.sema.package.mobile.sync";
    ...
    public static final class Intent {
         ...
         */
        public static final String INTENT_PREFIX = "com.sema.package.mobile.";
